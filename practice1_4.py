from bpla.module1.practice1_5 import GPS, DistanceSensor
...
class Drone:
    ...
    def __init__(self, model, weight, payload, id) -> None:
...
if __name__ == '__main__':
    ...
    # drone2.get_info()
    drone1.get_coords()
    # drone1.cur_coordinates = (12.1234, 32.4321)
    drone1.get_coords()
    drone1.get_coords()
    drone2.get_coords()

# магические методы по-особому обрабатываются интерпретатором
# деструктор вызывается при уничтожении экземляра класса
